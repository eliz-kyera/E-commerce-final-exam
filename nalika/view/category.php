...
<body>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												...
												<h2>Enter a Category</h2>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Product Category" name="cat_name" id="cat_name">
                                                    </div>
    ...
    ?>
          ...
          $cid = $value['cat_id'] ?></td>
          <td><div><a href='./_updatecat.php?cid=<?php echo($cid);?>'> <span class="fa fa-pencil"></span></a></div></td>
          <td><div><a href='../actions/delete_category.php?cid=<?php echo($cid);?>'> <span class="fa fa-trash"></span></a></div></td>
