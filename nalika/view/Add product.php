...
<body>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Add Category" href="category.php"><span class="mini-sub-pro">Category</span></a></li>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="single-product-tab-area mg-b-30">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                ...
                                <div class="input-group mg-b-pro-edt">
                                 ...
                                 <form method="POST" action="../actions/add_product.php" style='padding-bottom: 10px;' enctype="multipart/form-data">
                                    <input type="text"  name="category" id="category" class="form-control" placeholder="Category">
                                    
                                </div>
                                <select name="category" id="category" class="form-control pro-edt-select form-control-primary">
            ...
            <input type="text" id="form3Example3cg" class="form-control form-control-lg" name="ptitle"  required />
        </div>

        <div class="form-outline mb-4">
            <label class="form-label" for="form3Example3cg">Enter product price</label>
            <input type="number" id="form3Example3cg" class="form-control form-control-lg" name="price" required />
        </div>

        <div class="form-outline mb-4">
            <label class="form-label" for="form3Example3cg">Enter product description</label>
            <input type="text" id="form3Example3cg" class="form-control form-control-lg" name="pdesc" required />
        </div>
        ...
        <div class="form-outline mb-4">
            ...
            <input type="text" id="form3Example3cg" class="form-control form-control-lg" name="pkeywords" required />
        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" name="ptitle" id="ptitle" class="form-control" placeholder="Product Title">
                                                    </div>
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="price" name="price" id="price" class="form-control" placeholder="Product Price">
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites-button" aria-hidden="true"></i></span>
                                                        <input type="file" name= "pimage" id="pimage" class="form-control" placeholder="Product image">
                                                    </div>

                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites-button" aria-hidden="true"></i></span>
                                                        <input type="text" name="pkeywords" class="form-control" placeholder="Product keywords">
                                                    </div> -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                        <input type="price" class="form-control" placeholder="Product Price">
                                                    </div>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        <span class="input-group-addon"><i class="icon nalika-favorites-button" aria-hidden="true"></i></span>
                                                        <input type="text" class="form-control" placeholder="Product keywords">
                                                    </div> --> 
