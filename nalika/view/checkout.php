			...
			<div class="col-lg-4">
				<div class="total-section">
					...
					<div class="cart-buttons">
						...
						<a href="cart.php" class="boxed-btn black">Back to cart</a>
						<a href="" class="boxed-btn black" onclick="payWithPaystack()">Pay</a>
						<!-- <button type="submit" class="boxed-btn black" onclick="payWithPaystack()"> Pay </button> -->
							...
							function payWithPaystack() {
								...
								let handler = PaystackPop.setup({
									...
									callback: function(response) {
										...
										xhttp.open("GET", "../actions/process_payment.php?reference=" + response.reference, true);
										xhttp.send();
