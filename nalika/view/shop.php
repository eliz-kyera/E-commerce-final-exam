          ...
          ?>
					...
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.php?id=<?php echo $value['product_id']; ?>"><img src="<?php echo $value['product_image'] ?>" alt=""></a>
						</div>
	  ...
	  <!-- <?php
                ...
                <!-- <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            <li class="active" data-filter="*">All</li>
                            <li data-filter=".strawberry">Frames</li>
                            <li data-filter=".berry">Wood signs</li>
                            <li data-filter=".lemon">keychains</li>
							<li data-filter=".apple">keychains</li>
                        </ul>
                    </div>
                </div>
            </div>  -->
