...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="product-status mg-b-30">
          ...
          ?>
             <tr>
            <td> <?php echo $value['product_cat'];
                           ?></td>
            <td> <?php echo $value['product_brand'];
                             ?></td>
            <td> <?php echo $value['product_title'] ?></td>
            <td> <?php echo $value['product_price'] ?></td>
            <td> <?php echo $value['product_desc'] ?></td>
            <td> <img src="<?php echo $value['product_image'] ?>" width="50" height="50"></td>
            <td> <?php echo $value['product_keywords'] ?></td>
            <td>
            <button><a  href="product-edit.php?id=<?php echo $value['product_id'];?>&product_title=<?php echo $value['product_title']?>&product_price=<? echo $value['product_price'] ?>&product_desc=<?php echo $value['product_desc'] ?>&product_keywords=<?php echo $value['product_keywords'] ?>" data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a> 
            <button><a href= "../actions/delete_product.php?pid=<?php echo($pid);?>" data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
          ...
          ?>
                                <!-- <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <button<a  href="product-edit.html"data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a> 
