...
<body>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                <div class="review-content-section">
                                                    ...
                                                    <!-- <h3><label for="email"><b>Enter Product Brand</b></label><br></h3> -->
                                                    <div class="breadcomb-ctn">
												<h2>Enter a Brand</h2>
                                                    ...
                                                    <div class="input-group mg-b-pro-edt">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Product Brand" name="brand_name" id="brand_name">
                                                    </div>
    ...
    ?>
          ...
          <td><div><a href='./_updatebrand.php?bid=<?php echo($bid);?>'> <span class="fa fa-pencil"></span></a></div></td>
          <td><div><a href='../actions/delete_brands.php?bid=<?php echo($bid);?>'> <span class="fa fa-trash"></span></a></div></td>
